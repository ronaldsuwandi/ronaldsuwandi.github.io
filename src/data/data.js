module.exports = {
  ...
  works: [{
    ...
    list: [{
      ...
      description: `<p>My main role is to develop the new backend for our web application which 
originally written in Java and PostgreSQL.</p>

<ul>
<li>Distributed system consisting of multiple nodes for the web server written in Clojure, ElasticSearch and Cassandra.</li>
...
<li>Implemented API in REST architecture including various complex business rules</li>
