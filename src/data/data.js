module.exports = {
  ...
  works: [{
    ...
    list: [{
      ...
      description: `
<ul>
<li>Developed and architected performant API service for an environment with a low and unstable Internet connection. The service is consumed by both mobile and web apps using Go and Postgres</li>
