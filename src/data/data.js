...
and also gives you some suggestion keywords. Powered by jQuery and Big Huge Thesaurus.</p>`
    ...
    list: [{
      ...
      description: `<p>I joined Eyeota as a full stack engineer to work with Ember.js on the
frontend for our internal webapp. Then I worked on the backend side to do a complete rewrite of our
backend system using Clojure, ElasticSearch, and Cassandra stack.</p>

<p>The new backend offers much more flexibility, high performant and includes a complex access control
